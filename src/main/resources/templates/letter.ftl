        ...
        <div class="container">
            <ul class="letter-list">
                ...
                <li id="conversation-item-10005_622873">
                    <a class="letter-link" href="${contextPath}/msg/detail?conversationId=${conversation.conversation.conversionid!}"></a>
                    <div class="letter-info">
                        ...
                        <div class="l-operate-bar">
                            ...
                            <a href="${contextPath}/msg/detail?conversationId=${conversation.conversation.conversionid!}">
